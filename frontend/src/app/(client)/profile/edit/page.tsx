...
export default function EditProfilePage() {
  ...
  return (
    <div className=" bg-gray-50">
      <div className="px-4 py-4 mb-2 lg:mt-10 sm:px-8 sm:py-6">
        <BackButton className="inline-flex items-center gap-2 px-3 py-2 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50 transition-colors text-sm font-medium text-gray-700 cursor-pointer" />
      </div>

      <div className="flex justify-center px-4 sm:px-6">
        <form
          onSubmit={handleSubmit}
          className="w-full max-w-md bg-white rounded-2xl shadow-sm sm:shadow-lg p-5 sm:p-8"
        >
